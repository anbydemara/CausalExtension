...
class VisionTransformer(nn.Module):
    def __init__(self, image_size=224, patch_size=16, in_c=3, num_classes=1000,
        ...
        self.pos_embed = nn.Parameter(torch.zeros(1, num_patches + self.num_tokens, embed_dim)) # 可学习
...
def vit_custom():
    model = VisionTransformer(image_size=13, patch_size=1, in_c=102, embed_dim=512,depth=2, num_heads=2, representation_size=None, num_classes=7)
    return model